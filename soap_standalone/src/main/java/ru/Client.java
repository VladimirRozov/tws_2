...
import ru.itmo.generated.LoyaltyService_Service;
            ...
            */
            ...
            if (i != 0) {
                ...
                if (agree.equals("y")) {
                    ...
                    int cash = Integer.parseInt(updateRowsMap.get("cash").trim());
                    int spbsoId = Integer.parseInt(updateRowsMap.get("spbso").trim());
                    String event = updateRowsMap.get("event");

                    status = loyaltyService.getLoyaltyServicePort().updateLoyalty(rowId, spbsoId, name, event, cash, brigade);
     ...
     private static void deleteLoyaltyRowById(LoyaltyService_Service loyaltyService) {
      ...
      private static void createLoyaltyRow(LoyaltyService_Service loyaltyService) {
        ...
        if ((name != null && !name.trim().isEmpty())  &&
            ...
            try {
                cash = Integer.parseInt(cashStr.trim());
                spbsoId = Integer.parseInt(spbsoIdStr.trim());
